...
// defined outside EditTransportRoute — an inline definition would get a
...
export default function EditTransportRoute() {
    ...
    const loadData = async () => {
        ...
        try {
            const [routesData, companiesData, citiesData] =
                await Promise.all([
            ...
            setForm({
                ...
                origin_city_id: route.origin_city?.id ?? '',
                destination_city_id: route.destination_city?.id ?? '',
                duration_minutes: route.duration_minutes ?? '',
                price_approx: route.price_approx ?? '',
                transport_type: route.transport_type ?? 'bus',
                schedule_notes: route.schedule_notes ?? '',
                is_active: route.is_active ?? true,
            });

        } catch (err) {
            console.error('Load edit route data error:', err);
    ...
    return (
        <div>
            <PageHeader
                ...
                subtitle="Update transport route information."
            />
